# Generated by Django 4.2 on 2023-06-02 07:00
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    func='INSERT INTO "items_itemevent" ("base_yield_minutes", "buy_price", "can_buy", "can_craft", "can_mail", "can_master", "can_sell", "cooking_level", "cooking_recipe_item_id", "crafting_level", "created_at", "description", "id", "image", "locksmith_gold", "locksmith_grab_bag", "locksmith_key_id", "manual_fishing_only", "min_mailable_level", "name", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "reg_weight", "runecube_weight", "sell_price", "type", "xp") VALUES (NEW."base_yield_minutes", NEW."buy_price", NEW."can_buy", NEW."can_craft", NEW."can_mail", NEW."can_master", NEW."can_sell", NEW."cooking_level", NEW."cooking_recipe_item_id", NEW."crafting_level", NEW."created_at", NEW."description", NEW."id", NEW."image", NEW."locksmith_gold", NEW."locksmith_grab_bag", NEW."locksmith_key_id", NEW."manual_fishing_only", NEW."min_mailable_level", NEW."name", _pgh_attach_context(), NOW(), \'snapshot\', NEW."id", NEW."reg_weight", NEW."runecube_weight", NEW."sell_price", NEW."type", NEW."xp"); RETURN NULL;',
                    hash="95b59a69e6a044c61cf200204c193b117f110127",
                    operation="UPDATE",
